...
public class FigerParsedSentence {
	public int sectId;
	...
	public List<OneNer> blockNers = new ArrayList<OneNer>();
	public List<OneReverb> reverbs = new ArrayList<OneReverb>();
	...
	public FigerParsedSentence(int sectId, int sentId, String[] tkn, String[] pos, String[] ner, String[] lmma,
			List<SentDep> deps) {
		this.sectId = sectId;
		this.sentId = sentId;
		this.tkn = tkn;
